...
func (m *State) GetProgramName() string {
	if m != nil {
...
func (m *State) GetCullFace() State_Cullface {
	if m != nil {
		return m.CullFace
	}
...
func (m *State) GetBlendSrcMode() State_BlendMode {
	if m != nil {
		return m.BlendSrcMode
	}
	return State_BLEND_SRC_ALPHA
}

func (m *State) GetBlendDstMode() State_BlendMode {
	if m != nil {
		return m.BlendDstMode
	}
	return State_BLEND_SRC_ALPHA
}

func (m *State) GetBlendEquation() State_BlendEquation {
	if m != nil {
		return m.BlendEquation
	}
	return State_BLEND_FUNC_ADD
}

func (m *State) GetDepthTest() bool {
	if m != nil {
		return m.DepthTest
	}
	return false
...
func (m *State) GetDepthWrite() bool {
	if m != nil {
		return m.DepthWrite
	}
	return false
...
func (m *State) GetDepthFunc() State_DepthFunc {
	if m != nil {
		return m.DepthFunc
	}
...
func (m *State) GetColorWrite() bool {
	if m != nil {
		return m.ColorWrite
	}
	return false
...
func (m *State) GetScissorTest() bool {
	if m != nil {
		return m.ScissorTest
	}
	return false
}
...
var fileDescriptor1 = []byte{
	...
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0x8c, 0x53, 0xcf, 0x8f, 0xd2, 0x4e,
